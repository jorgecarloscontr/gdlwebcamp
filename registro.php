    ...
    <form id="registro" class="registro" action="validar_registro.php" method="post">
      <div id="datos-usuario "class="registro caja clearfix">
        <div class="campo">
          ...
          <input type="text" id="nombre" name="nombre" value="" placeholder="Tu nombre">
        </div>
        <div class="campo">
          <label for="apellifo">Apellido: </label>
          <input type="text" id="apellido" name="apellido" value="" placeholder="Tu apellido">
        </div>
        <div class="campo">
          <label for="e-mail">Email: </label>
          <input type="email" id="email" name="email" value="" placeholder="Tu Email">
        </div>
        <div id="error"></div>
        ...
        <ul class="lista-precios clearfix">
          <li>
            <div class="tabla-precio">
              ...
              <p class="numero">$30</p>
              <ul>
                <li class="fas fa-check">Bocadillos Gratis</li>
                <li class="fas fa-check">todas las conferencias</li>
                <li class="fas fa-check">Todos los talleres</li>
              </ul>
              <div class="orden">
          ...
          <li>
            <div class="tabla-precio">
              <h3>pase por 2 dia [viernes y sabados]</h3>
              <p class="numero">$45</p>
              <ul>
                <li class="fas fa-check">Bocadillos Gratis</li>
                <li class="fas fa-check">todas las conferencias</li>
      ...
      <div id="resumen" class="resumen">
        ...
        <div class="caja clearfix">
          ...
          <div class="total">
            <p>resumen</p>
            <div class="lista-producto" id="lista-productos">
